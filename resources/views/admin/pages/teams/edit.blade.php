                            ...
                            <div class="col-xl-2">
                                <div class="mb-5">
                                    <img id="showImage" width="100px"
                                        src="{{ $team->image == '' ? url('no-image.jpg') : asset($team->image) }}">
                                </div>
                            </div>
                            <div class="col-xl-10">
                                <div class="mb-5">
                                    ...
                                    <div class="mb-5">
                                        ...
                                        <div class="input-group mb-3">
                                            ...
                                            <select class="form-control" name="role">
                                                <option
                                                    value="instructor"{{ $team->role === 'instructor' ? ' selected' : '' }}>
                                                    Instructor</option>
                                                <option value="student"{{ $team->role === 'student' ? ' selected' : '' }}>
                                                    Student</option>
                                            </select>
                                        </div>
                                    </div>
                            ...
                            <div class="col-xl-12">
                                <div class="mb-5">
                                    ...
                                    <div class="input-group mb-3">
                                        ...
                                        <textarea rows="5" class="form-control" name="description">{{ $team->description }}</textarea>
                                    </div>
                                </div>
                            </div>
                        </div>
